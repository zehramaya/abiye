...
class FalStream {
    constructor(endpointId, config, options) {
        ...
        this.start = () => __awaiter(this, void 0, void 0, function* () {
            ...
            const { input, method = "post", connectionMode = "server", tokenProvider, } = options;
            try {
                if (connectionMode === "client") {
                    // if we are in the browser, we need to get a temporary token
                    // to authenticate the request
                    const appId = (0, utils_1.ensureEndpointIdFormat)(endpointId);
                    const resolvedPath = (_a = (0, utils_1.resolveEndpointPath)(endpointId, undefined, "/stream")) !== null && _a !== void 0 ? _a : "";
                    const fetchToken = tokenProvider
                        ? () => tokenProvider(`${appId}${resolvedPath}`)
                        : () => {
                            console.warn("[fal.stream] Using the default token provider is deprecated. " +
                            ...
                            return (0, auth_1.getTemporaryAuthToken)(endpointId, this.config);
                        };
                ...
                return yield (0, request_1.dispatchRequest)({
                    ...
                    options: {
                        headers: {
                            accept: (_c = options.accept) !== null && _c !== void 0 ? _c : CONTENT_TYPE_EVENT_STREAM,
                        },
        ...
        this.url =
            (_a = options.url) !== null && _a !== void 0 ? _a : (0, request_1.buildUrl)(endpointId, {
                path: (0, utils_1.resolveEndpointPath)(endpointId, undefined, "/stream"),
